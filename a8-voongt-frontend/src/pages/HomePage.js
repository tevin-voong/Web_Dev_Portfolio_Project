...
function HomePage() {
    return (
        <>
            <section><h2>Web Dev Home Page</h2></section>
    {<article>
        <p>
        Welcome to my web app! This website used a combination of different technologies to create this final product. The details of the web app is formed with the used of
        HTML and CSS. The web app also displays images optimized for the web and in a slideshow gallery. Different icons for buttons and submittals are imported to be used in different pages of the site as well. This page imports the Bebas Nueue font from Google fonts and 
        is used throughout the site. Functionaility of the pages is created by using Javascript. This site also makes use of the Express framework to get, post, and delete data. I have also implemented Mongoose,
        which is a JavaScript library that provides a syntactic layer between the data in a database's collection of documents and the objects in a Node app. This app used Node and the library of Javascript modules
        provided to help with developing the app. Futhermore, this web app makes use of React to build pages with components and the REST API.
        </p>
    </article>
